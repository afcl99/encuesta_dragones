...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'firstname' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null],
        'lastname' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf8_bin', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                'username' => '31b538dd-78bb-42b3-9ec6-dcfe4224e2d6',
                'password' => 'Lorem ipsum dolor sit amet',
                'firstname' => 'Lorem ipsum dolor sit amet',
                'lastname' => 'Lorem ipsum dolor sit amet',
                'role' => 'Lorem ip',
                'active' => 1,
                'created' => '2020-02-26 06:42:21',
                'modified' => '2020-02-26 06:42:21',
            ],
        ];
        parent::init();
    }
